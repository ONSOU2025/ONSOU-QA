...
const faqData = [
    ...
    {
        category: "3. プレイと上達",
        subcategory: "🔹 設定・オプション",
        question: "Q: 音ズレを調整するための設定はありますか？",
        answer: "A: 選択画面の設定メニュー内にある「**オフセット**」から、細かく設定できます。ご自身の端末に合わせて調整してください。",
        image: null,
        popularity: 9,
        date: "2025-10-30"
    },
    {
        ...
        answer: "A: 選択画面の設定メニュー内にある「**判定モード**」から判定の難易度を調整できます。ご自身の実力に合わせて調整してください",
        image: null,
        popularity: 5,
        date: "2025-10-30"
    },
    {
        category: "3. プレイと上達",
        subcategory: "🔹 設定・オプション",
        question: "Q: ハイスピード（ノーツが流れる速さ）はどのように調整するのがおすすめですか？",
        answer: "A: プレイしてみて、遅いと感じれば**1ずつ上げて**みてください。",
        image: null,
        popularity: 5,
        date: "2025-11-02"
    },
    {
        category: "3. プレイと上達",
        subcategory: "🔹 設定・オプション",
        question: "Q: 判定音が大きい場合どうすればいいですか？",
        answer: "A: タイトル画面の設定メニュー内にある「**判定音量**」から判定の音量を調整できます。ご自身の実力に合わせて調整してください",
        image: null,
        popularity: 5,
        date: "2025-11-02"
    },
    ...
    },
    {
        category: "4. トラブル・サポート",
        subcategory: "🔹 不具合・バグ",
        question: "Q: ボタンやパネルが反応しない/誤作動する場合、一時的な対処法や確認すべき点は何ですか？",
        answer: "A: 接続部分を一度さしなおしてみてください。それでも解決しない場合は、OSとアプリのバージョンを添えて**公式ディスコードサーバーや、公式X（旧Twitter）**にご報告お願いします。",
        image: null,
        popularity: 7,
        date: "2025-11-02"
    },
    {
        category: "4. トラブル・サポート",
        subcategory: "🔹 不具合・バグ",
        question: "Q: プレイ中に処理落ちしたり、カクついたりする場合の対策を教えてください。",
        answer: "A: 他のアプリを終了させたり、端末を再起動、音奏の再起動などをすることで改善する場合があります。それでも解決しない場合は、OSとアプリのバージョンを添えて**公式ディスコードサーバーや、公式X（旧Twitter）**にご報告お願いします。",
        image: null,
        popularity: 7,
        date: "2025-11-02"
    },
